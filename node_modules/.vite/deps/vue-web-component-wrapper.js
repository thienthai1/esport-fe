...
// node_modules/vue-web-component-wrapper/package/dist/vue-web-component-wrapper.es.js
var F = Object.defineProperty;
var G = (e, n, t) => n in e ? F(e, n, { enumerable: true, configurable: true, writable: true, value: t }) : e[n] = t;
...
var te = typeof HTMLElement < "u" ? HTMLElement : class {
};
var T = class _T extends te {
  constructor(t, s = {}, o = { shadowRoot: true }, r) {
    super();
    m(this, "_instance", null);
    m(this, "_connected", false);
    m(this, "_resolved", false);
    m(this, "_numberProps", null);
    m(this, "_styles");
    m(this, "_slots", {});
    m(this, "_ob", null);
    this._def = t, this._props = s, this._config = o, this._root && r ? r(this._createVNode(), this._root) : (this._config.shadowRoot !== false && this.attachShadow({ mode: "open" }), this._def.__asyncLoader || this._resolveProps(this._def));
  }
  get _root() {
  ...
  disconnectedCallback() {
    this._connected = false, nextTick(() => {
      this._connected || (this._ob && (this._ob.disconnect(), this._ob = null), render(null, this._root), this._instance = null);
    });
  }
  /**
  ...
  _resolveDef() {
    ...
    const t = (o, r = false) => {
      ...
      if (i && !$(i))
        for (const d in i) {
          const c = i[d];
          (c === Number || c && c.type === Number) && (d in this._props && (this._props[d] = C(this._props[d])), (E || (E = /* @__PURE__ */ Object.create(null)))[S(d)] = true);
        }
      if (this._numberProps = E, r && this._resolveProps(o), !this._config.shadowRoot) {
        ...
        const d = (c) => Array.from(c).map((l) => {
          ...
          if (l.nodeType === Node.ELEMENT_NODE) {
            ...
            return ((h2 = l.textContent) == null ? void 0 : h2.trim()) || null;
          return null;
        }).filter((l) => l != null);
        for (const c of Array.from(this.childNodes)) {
          ...
          if (this._slots[l] || (this._slots[l] = []), c.nodeType === Node.ELEMENT_NODE) {
            const h2 = c, u = Object.fromEntries(
              Array.from(h2.attributes).map((b) => [b.name, b.value])
            );
            this._slots[l].push(
              h(
                h2.tagName.toLowerCase(),
                u,
                d(h2.childNodes)
              )
            );
          } else if (c.nodeType === Node.TEXT_NODE) {
            const h2 = (y = c.textContent) == null ? void 0 : y.trim();
            h2 && this._slots[l].push(h2);
          }
        }
    ...
    s ? s().then((o) => t(o, true)) : t(this._def);
  }
  _resolveProps(t) {
    const { props: s } = t, o = $(s) ? s : Object.keys(s || {});
    for (const r of Object.keys(this))
      r[0] !== "_" && o.includes(r) && this._setProp(r, this[r], true, false);
  ...
  _setAttr(t) {
    ...
    const o = S(t);
    this._numberProps && this._numberProps[o] && (s = C(s)), this._setProp(o, s, false);
  }
  /**
   * @internal
   */
   ...
   * @internal
   */
  _setProp(t, s, o = true, r = true) {
    s !== this._props[t] && (this._props[t] = s, r && this._instance && this._update(), o && (s === true ? this.setAttribute(N(t), "") : typeof s == "string" || typeof s == "number" ? this.setAttribute(N(t), s + "") : s || this.removeAttribute(N(t))));
  }
  _update() {
    render(this._createVNode(), this._root);
  }
  _createVNode() {
    const t = createVNode(this._def, Z({}, this._props), this._slots);
    return this._instance || (t.ce = (s) => {
      this._instance = s, s.isCE = true;
      const o = (i, _) => {
        this.dispatchEvent(
          new CustomEvent(i, {
            detail: _
...
var re = ({
  ...
  loaderAttribute: l,
  hideSlotContentUntilMounted: h2,
  nonce: u
}) => {
    ...
    setup(K, { slots: U }) {
      ...
      f.mixin({
        mounted() {
          ...
          p && (h2 && p.querySelectorAll("[hidden]").forEach((q) => {
      ...
      const w = i();
      if (Object.assign(w.appContext, f._context), Object.assign(w.provides, f._context.provides), window.__VUE_DEVTOOLS_GLOBAL_HOOK__) {
...
var ce = ({
  ...
  disableRemoveStylesOnUnmount: E = false,
  disableShadowDOM: y = false,
  replaceRootWithHostInCssFramework: d = false,
  asyncInitialization: c = () => Promise.resolve(),
  loaderAttribute: l = "data-web-component-loader",
  hideSlotContentUntilMounted: h2 = false,
  nonce: u
...
vue-web-component-wrapper/package/dist/vue-web-component-wrapper.es.js:
  ...
  **)
  (*!#__NO_SIDE_EFFECTS__*)
*/
//# sourceMappingURL=vue-web-component-wrapper.js.map
